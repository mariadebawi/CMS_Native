        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavCmS">
                ...
                <ul class="navbar-nav mr-auto ">
                    <li class="nav-item ">
                        <a class="nav-link" href=Blog.php.php">
    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col-md-8">
                ...
                while ($DataRows = $stmt->fetch()) {
                    ...
                    <div class="card my-3">
                        ...
                        <div class="card-body">
                            ...
                            <?php
                                $sqll = "SELECT * from comments WHERE Post_id = $PostId ;";
                                $stm = $ConnectingDb->prepare($sqll); 
                                $stm->execute() ;
                                $Count = $stm->rowCount() ;
                              ?>
                         <span class="badge badge-dark text-light float-right">Comments : <?php echo $Count ; ?></span>
                            <hr>
                ...
                global $ConnectingDb ;
                //status must be ON
                    $sql = "SELECT * from comments WHERE post_id ='$PostUrl' ";
                    $stmt = $ConnectingDb->query($sql);
